...
describe('POST /api/v1/housingSubscription/getHousingSlots', () => {
    ...
    */
    // id non conforme
    test('POST /api/v1/housingSubscription/getHousingSlots con id non conforme e token non valido', () => {
    ...
    // id non presente
    test('POST /api/v1/housingSubscription/getHousingSlots con id alloggio assente e token non valido', () => {
        return request(app).post('/api/v1/housingSubscription/getHousingSlots')
    ...
    test('POST /api/v1/housingSubscription/getHousingSlots con alloggio non esistente e token non valido', () => {
        return request(app).post('/api/v1/housingSubscription/getHousingSlots')
        .send({token: tokenNoV, id:"627fdec095b0619bf9e00000"}).set('Accept', 'application/json')
        .expect(404, {success: false, message: "HousingNotFound"});
    });

    // alloggio esistente
    test('POST /api/v1/housingSubscription/getHousingSlots con alloggio esistente e token non valido', () => {
        return request(app).post('/api/v1/housingSubscription/getHousingSlots')
...
describe('POST /api/v1/housingSubscription/subscribeHousing', () => {
    ...
    test('POST /api/v1/housingSubscription/subscribeHousing con ordine data inizio/finale scorretto', () => {
        ...
        .expect(200, {success: false, message: "BadDateOrder"});
    });
    ...
    // date assenti
    test('POST /api/v1/housingSubscription/subscribeHousing con date assenti', () => {
        return request(app).post('/api/v1/housingSubscription/subscribeHousing')
        .send({
            token: tokenVal,
            housingId:"627fdec095b0619bf9e97717"
    ...
    test('POST /api/v1/housingSubscription/subscribeHousing con token non valido', () => {
        ...
        .expect(401, {success: false, message: "TokenNotValid"});
    });
    ...
    test('POST /api/v1/housingSubscription/subscribeHousing con data iniziale non coerente con alloggio specifico', () => {
        ...
        .expect(200, {success: false, message: "BadDateOffset"});
    });
    ...
    test('POST /api/v1/housingSubscription/subscribeHousing con sovrapposizione slot', () => {
        return request(app).post('/api/v1/housingSubscription/subscribeHousing')
        .send({
            token: tokenVal,
            housingId:"627fdec095b0619bf9e97717",
        ...
        .expect(200, {success: false, message: "DateSlotOverlap"});
    });
