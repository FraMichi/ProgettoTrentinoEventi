...
router.get('/eventReview', async (req, res) => {
   ...
   // Risorsa finale
   let reviewList = eventReview.map((review) => {return{recensione: review.recensione, risposta: review.risposta, id: review._id};})
...
router.get('/housingReview', async (req, res) => {
   ...
   // Risorsa finale
   let reviewList = housingReview.map((review) => {return{recensione: review.recensione, risposta: review.risposta, id: review._id};})
   console.log(reviewList);
   res.status(200).json(reviewList);
});
